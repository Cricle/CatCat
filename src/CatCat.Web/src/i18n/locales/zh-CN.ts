export default {
  ...
  pet: {
    ...
    serviceInfo: '服务信息',
    foodLocation: '猫粮位置',
    foodLocationPlaceholder: '例如：厨房橱柜第二层',
    waterLocation: '水盆位置',
    waterLocationPlaceholder: '例如：客厅电视柜旁边',
    litterBoxLocation: '猫砂盆位置',
    litterBoxLocationPlaceholder: '例如：卫生间角落',
    cleaningSuppliesLocation: '清洁用品位置',
    cleaningSuppliesPlaceholder: '例如：阳台储物柜（扫把、猫屎袋等）',
    needsWaterRefill: '需要备水',
    specialInstructions: '特殊说明',
    specialInstructionsPlaceholder: '例如：猫粮每次半碗、水要换新的',
    male: '公',
    female: '母',
    cat: '猫',
    dog: '狗',
